...
## Git Commits
- MUST DO: atomic, each commit should represent one logically complete, indivisible change that can be reverted independently without breaking the repository.
...
- read hbs-dev skill when focusing hbs project
